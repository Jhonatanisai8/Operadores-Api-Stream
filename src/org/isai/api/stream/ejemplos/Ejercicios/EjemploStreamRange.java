...
/*
El operador range es una forma concisa y eficiente de generar
...
public class EjemploStreamRange {
    ...
    public static void ejemplo01rangeStream() {
        System.out.println("\tOperador RANGE");
    ...
    public static void ejemplo03rangeStreamIntSummaryStatistics() {
        ...
        IntStream numeros = IntStream.range(1, 11).peek(System.out::println);
